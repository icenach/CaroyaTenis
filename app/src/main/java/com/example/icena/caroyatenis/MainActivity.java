...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            ...
            TextView txtMail = (TextView) headerView.findViewById(R.id.txtMail);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.draws) {
            Intent intent = new Intent(this, CuadrosActivity.class);
            startActivity(intent);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    tab_vivo tab_vivo = new tab_vivo();
                    return tab_vivo;
                case 1:
                    tab_terminados tab_terminados = new tab_terminados();
                    return tab_terminados;
                case 2:
